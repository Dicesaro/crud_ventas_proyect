class FacturasController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to facturas_path, status: :see_other, notice: "Factura was successfully destroyed." }
  ...
  private
    ...
    def factura_params
      params.require(:factura).permit(:pedido_id, :numero_factura, :fecha_emision, :total, :iva, :descuento)
    end
end
