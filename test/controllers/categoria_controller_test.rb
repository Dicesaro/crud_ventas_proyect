...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference("Categorium.count") do
      post categoria_url, params: { categorium: { codigo: @categorium.codigo, descripcion: @categorium.descripcion, estado: @categorium.estado, fecha_creacion: @categorium.fecha_creacion, nombre: @categorium.nombre, tipo: @categorium.tipo } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { codigo: @categorium.codigo, descripcion: @categorium.descripcion, estado: @categorium.estado, fecha_creacion: @categorium.fecha_creacion, nombre: @categorium.nombre, tipo: @categorium.tipo } }
