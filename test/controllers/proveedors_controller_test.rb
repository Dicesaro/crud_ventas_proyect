...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference("Proveedor.count") do
      post proveedors_url, params: { proveedor: { contacto: @proveedor.contacto, direccion: @proveedor.direccion, email: @proveedor.email, fecha_registro: @proveedor.fecha_registro, nombre: @proveedor.nombre, telefono: @proveedor.telefono } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { contacto: @proveedor.contacto, direccion: @proveedor.direccion, email: @proveedor.email, fecha_registro: @proveedor.fecha_registro, nombre: @proveedor.nombre, telefono: @proveedor.telefono } }
