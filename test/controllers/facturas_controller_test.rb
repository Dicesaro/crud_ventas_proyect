...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference("Factura.count") do
      post facturas_url, params: { factura: { descuento: @factura.descuento, fecha_emision: @factura.fecha_emision, iva: @factura.iva, numero_factura: @factura.numero_factura, pedido_id: @factura.pedido_id, total: @factura.total } }
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { descuento: @factura.descuento, fecha_emision: @factura.fecha_emision, iva: @factura.iva, numero_factura: @factura.numero_factura, pedido_id: @factura.pedido_id, total: @factura.total } }
